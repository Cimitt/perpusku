    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-24">
      ...
      <Dialog open={borrowBlockDialogOpen} onOpenChange={setBorrowBlockDialogOpen}>
        <DialogContent className="sm:max-w-[430px]">
          <DialogHeader>
            <DialogTitle>Peminjaman Ditahan</DialogTitle>
            <DialogDescription>
              Selesaikan pembayaran denda terlebih dahulu agar bisa mengajukan peminjaman baru.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div className="rounded-lg border border-red-100 bg-red-50 p-3 text-xs leading-relaxed text-red-700">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setBorrowBlockDialogOpen(false)}>
              Tutup
            </Button>
            <Button
              onClick={() => {
